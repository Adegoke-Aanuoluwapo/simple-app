      ...
      <section class="section-box">
        <div class="banner-hero banner-breadcrums">
          <div class="container text-center">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="text-heading-2 color-gray-900 mb-20">
                  Simple App<br
          ...
          <div class="content-detail">
            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                ...
                <p>
                  Communication: Communicate the results of UX activities within
                  your product area to the design team department,
                  cross-functional partners within your product area, and other
                  interested Superformula team members using clear language that
              ...
              <div class="media-block">
                  <a
                    ...
                    href="page-signup.html" style="margin-left: 400px"
                    >Apply Now</a
                  >
